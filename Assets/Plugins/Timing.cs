...
public static class MECExtensionMethods
{
    ...
    {
        while (TrinarySoftware.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
    ...
    {
        while (TrinarySoftware.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy && 
